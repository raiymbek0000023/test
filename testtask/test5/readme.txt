...
Ваш питон скрипт (который должен быть создан внутри папки testtask) должен 
пробежаться по содержимому папки и папок внутри папок, и сохранить в excel файл "result.xlsx" список лежащих там файлов в формате:
